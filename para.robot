*** Settings ***
Library    ExcelHandler.py    C:\Users\t001404\OneDrive - The Siam Commercial Bank PCL\QA\RobotrunnerGUI\UDP_SIT_MVP3.xlsx    BD1
...
*** Test Cases ***
Open Notebooks In Chunk
    ${chunk_start}=    Get Environment Variable    ROBOT_CHUNK_START
    ${chunk_end}=      Get Environment Variable    ROBOT_CHUNK_END
    ${chunk_start}=    Convert To Integer    ${chunk_start}
    ${chunk_end}=      Convert To Integer    ${chunk_end}

    Open Browser    ${BASE_URL}    ${BROWSER}
    Maximize Browser Window
    Wait Until Element Is Visible    ${LOGIN_XPATH}    timeout=10s
